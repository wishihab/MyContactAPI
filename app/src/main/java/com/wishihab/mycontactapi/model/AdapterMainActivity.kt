...
//
//class MainUserAdapter(var randomUser:Main_RandomUser?): RecyclerView.Adapter<RandomUserAdapter.RandomUserViewHolder>(){
//
...
//    }
//
//    class MainUserViewHolder(view: View): RecyclerView.ViewHolder(view){
